...
public class ForeverAChild {
    ...
    public static final Tag.Named<Item> AGE_LOCKING_TAG = ItemTags.bind(MOD_ID + ":age_locking");
    public static final Tag.Named<Item> AGE_UNLOCKING_TAG = ItemTags.bind(MOD_ID + ":age_unlocking");
